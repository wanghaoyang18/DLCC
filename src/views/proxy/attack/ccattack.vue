...
<div>
    ...
    <div class="table-box">
    <el-card>
       <el-card class="searchresult">SearchResult <el-button class="button_check"> <i class="el-icon-search"></i> 统计</el-button><el-button class="button_check"> <i class="el-icon-view"></i> 查找</el-button></el-card>
                ...
                operationType:"",
                 options: [{
                    ...
                    label: 'QUERY_DCL'
                     ...
                     value5: [],
                    value11: [],
                mysqldata: [{time:"2018-10-21 04:34:46",realIp:"192.168.182.1",method:"GET",address:"localhost/test?ad=../1sd",ua:"-",data:"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36",ruletag:"cc_attack"},
                {time:"2018-10-21 04:34:46",realIp:"192.168.182.1",method:"cc",address:"localhost/test?ad=../1sd",ua:"-",data:"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36",ruletag:"cc_attack"},
                {time:"2018-10-21 04:34:46",realIp:"192.168.182.1",method:"cc",address:"localhost/test?ad=../1sd",ua:"-",data:"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36",ruletag:"cc_attack"},
                {time:"2018-10-21 04:34:46",realIp:"192.168.182.1",method:"cc",address:"localhost/test?ad=../1sd",ua:"-",data:"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36",ruletag:"cc_attack"},
                {time:"2018-10-21 04:34:46",realIp:"192.168.182.1",method:"cc",address:"localhost/test?ad=../1sd",ua:"-",data:"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36",ruletag:"cc_attack"},
                {time:"2018-10-21 04:34:46",realIp:"192.168.182.1",method:"cc",address:"localhost/test?ad=../1sd",ua:"-",data:"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36",ruletag:"cc_attack"},
